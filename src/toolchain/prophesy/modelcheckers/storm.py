...
class StormModelChecker(ParametricProbabilisticModelChecker, ProbablisticModelChecker):
    ...
    def sample_pctl_formula(selfself, prism_filepath, pctl_filepath, samplepoints):
